...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //subash
    NSString* firstname = [arrayList[indexPath.row] objectForKey:@"first_name"];
    NSString* lastname = [arrayList[indexPath.row] objectForKey:@"last_name"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [self performSegueWithIdentifier:@"CL2CDVC" sender:indexPath];
}
